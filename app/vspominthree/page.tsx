...
const page = ({ onMenuClick }: any) => {
  return (
    <div>
      ...
      {/* Header section -------------------------------- */}
      <div
        className="bg-cover bg-no-repeat p-8  md:p-16 lg:pt-36 bg-white"
      >
        <div className="container mx-auto flex flex-col lg:flex-row items-start justify-between">
          ...
          <div className="lg:max-w-lg w-full space-y-6">
            ...
            <div className="text-center max-w-lg space-y-3 text-[#0CF724]">
              <h3 className="text-2xl md:text-3xl lg:text-4xl ">Mario Danilo Primo</h3>
              <p className="text-lg md:text-xl ">14.01.1948 - 21.02.2024</p>
          ...
          <div className="space-y-6">
            <div className="p-6 md:p-8 lg:p-12 rounded-lg shadow-custom-light-dark-with-white bg-gradient-to-tr from-[#E3E8EC] to-[#FFFFFF] space-y-4">
              ...
              <p className="text-[#414141]">
                Sporočamo žalostno vest, da je nas je v <span className="text-[#0CF724]">76</span>. letu starosti zapustil <br /> naš predragi <span className="text-[#0CF724]">Mario Danilo Primo.</span> Vsi njegovi.
              </p>
            </div>
            ...
            <div className="p-6 md:p-8 lg:p-12 rounded-lg shadow-custom-light-dark-with-white bg-gradient-to-tr from-[#E3E8EC] to-[#FFFFFF] space-y-4">
              ...
              <div className="flex flex-col md:flex-row justify-between gap-6 pb-8 ">
                <div className="w-fit px-4 py-2 rounded-lg bg-[#2592c9] text-white">
                  <h3 className="text-2xl md:text-4xl font-bold text-[#0CF724]">9</h3>
                  <p className="text-sm md:text-lg text-[#0CF724]">sep</p>
                </div>
                <div className="space-y-1 text-[#0CF724] font-bold">
                  <h3 className="text-lg md:text-2xl ">Zadnje slovo</h3>
                  <p className="">Torek, <span className="text-[#1E2125]">ob</span> 9:00</p>
                  <p className="">
              ...
              <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                ...
                <div className="space-y-1 text-[#0CF724]">
                  <h3 className="text-lg md:text-2xl ">Pogreb</h3>
                  <p className="">Torek, <span className="text-[#1E2125]">ob</span> 9:00</p>
                  <p className="">
                    Poslovilna vežica, Pokopališče v Gabrskem, Trbovlje
                  </p>
  ...
  <div className="w-full">
   <div className="my-12 w-fit mx-auto text-center space-y-4">
